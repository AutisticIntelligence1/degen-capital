      ...
      <div className="min-h-screen bg-gray-950 text-white">
        ...
        <header className="relative overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <svg viewBox="0 0 100 100" className="h-12 w-12">
                  <circle cx="50" cy="50" r="45" fill="#10B981" className="animate-pulse"/>
          ...
          <div className="relative container mx-auto px-6 pt-20 pb-24 text-center">
            <h1 className="text-6xl font-bold mb-6 bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent animate-pulse">
...
<!-- Rest of the sections until Hot Tokens --><div className="grid md:grid-cols-4 gap-6">
            <div
